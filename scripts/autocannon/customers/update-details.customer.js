    ...
    autocannon(
        {
            ...
            url: AUTOCANNON_DATA.ROUTES.CUSTOMERS.UPDATE_CUSTOMER_PROFILE_DETAILS.ENDPOINT,
            method: AUTOCANNON_DATA.ROUTES.CUSTOMERS.UPDATE_CUSTOMER_PROFILE_DETAILS.METHOD,
